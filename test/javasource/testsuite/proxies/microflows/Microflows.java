...
public class Microflows
{
	...
	public static void altEntities(IContext context, testsuite.proxies.Color _color)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			params.put("Color", _color == null ? null : _color.getMendixObject());
			Core.execute(context, "TestSuite.AltEntities", params);
		}
	...
	public static void refresh(IContext context, testsuite.proxies.Color _color)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			params.put("Color", _color == null ? null : _color.getMendixObject());
			Core.execute(context, "TestSuite.Refresh", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
	...
	public static boolean test(IContext context)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			return (Boolean)Core.execute(context, "TestSuite.Test", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
	...
	public static boolean test_0(IContext context, testsuite.proxies.Color _color)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			params.put("Color", _color == null ? null : _color.getMendixObject());
			return (Boolean)Core.execute(context, "TestSuite.Test_0", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
